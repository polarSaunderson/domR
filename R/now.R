now <- function(format = "f") {
  #' Return the current date in easier formats
  #'
  #' @description When we want the current date, we need awkward and/or verbose
  #'   syntax to get the correct formatting. This function offers some simpler
  #'   options.
  #'
  ...
  #'     * "t"(or 3)    "yyyy-mm-dd HH:MM:ss zzz" e.g. "15:24:43"
  #'     * "Y"(or 4)    yyyy                      e.g. 2023
  #'     * "m"(or 5)    m                         e.g. 7
  #'     * "b"(or 6)    "Mth"                     e.g. "Jul"
  #'     * "B"(or 7)    Month                     e.g. "July"
  #'     * "d"(or 8)    dd                        e.g. 29
  #'     * any other letter accepted by `strptime()`
  #'
  #' @export
