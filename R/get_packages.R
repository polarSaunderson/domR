get_packages <- function(seshInfo = NULL,
  ...
  #'   "namespace" but not attached (i.e. those called with a "::", such as
  #'   `domR::made_up_demo_function()`).
  #'
  ...
  if (whichPackages %in% c("base", "b")) {
    ...
    stop("Select either 'base', 'namespace', or 'attached'",
         "in get_packages()")
  }
